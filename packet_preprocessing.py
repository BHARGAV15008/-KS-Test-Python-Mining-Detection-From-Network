...
class PacketPreprocessor:
    ...
    def extract_intervals(self, packets: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        # Process each connection to extract intervals
        ...
        for conn_id, conn_packets in connections.items():
            ...
            if len(conn_packets) <= 1:
                ...
                # Skip connections with only one packet (no interval)

                continue

                

            # Extract connection metadata from first packet
            ...
            # Calculate intervals for this connection
