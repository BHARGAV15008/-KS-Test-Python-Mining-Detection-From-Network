...
class PacketCapture:
    ...
    def read_pcap(pcap_file: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            cap.close()  # Ensure proper cleanup
        ...
        try:
            ...
            if hasattr(packet, 'ip'):
                ...
                if hasattr(packet, 'tcp'):
                    ...
                    return None
                packet_info['conn_id'] = f"{packet_info['src_ip']}:{packet_info['src_port']}-{packet_info['dst_ip']}:{packet_info['dst_port']}-{packet_info['protocol']}"
                return packet_info
            else:
                return None
        except Exception as e:
